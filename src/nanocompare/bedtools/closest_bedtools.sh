...
tool_fn_list=(K562_WGBS_Joined-meth-cov-DeepSignal-baseCount0.bed K562_WGBS_Joined-meth-cov-DeepMod-baseCount0.bed K562_WGBS_Joined-meth-cov-DeepMod_cluster-baseCount0.bed K562_WGBS_Joined-meth-cov-Tombo-baseCount0.bed)
