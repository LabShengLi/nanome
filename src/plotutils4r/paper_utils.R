...
fig.5newA.upset.plot.set5 <- function(ret, outfn) {
    ## Convert intersection to upset input
    # comb = c("A" = ret[1], "B" = ret[2], "C" = ret[3],
    #          "D" = ret[4], "E" = ret[5],
    #          "A&B" = ret[6], "A&C" = ret[7], "A&D" = ret[8], "A&E" = ret[9], "B&C" = ret[10],
    #          "B&D" = ret[11], "B&E" = ret[12], "C&D" = ret[13], "C&E" = ret[14], "D&E" = ret[15],
    #          "A&B&C" = ret[16], "A&B&D" = ret[17], "A&B&E" = ret[18], "A&C&D" = ret[19],
    #          "A&C&E" = ret[20], "A&D&E" = ret[21], "B&C&D" = ret[22],
    #          "B&C&E" = ret[23], "B&D&E" = ret[24], "C&D&E" = ret[25],
    #          "A&B&C&D" = ret[26], "A&B&C&E" = ret[27], "A&B&D&E" = ret[28], "A&C&D&E" = ret[29], "B&C&D&E" = ret[30],
    #          "A&B&C&D&E" = ret[31]
    # )
    
    comb = c("DeepSignal" = ret[1], "Tombo" = ret[2], "Nanopolish" = ret[3],
             "DeepMod" = ret[4], "Megalodon" = ret[5],
             "DeepSignal&Tombo" = ret[6], "DeepSignal&Nanopolish" = ret[7], "DeepSignal&DeepMod" = ret[8], "DeepSignal&Megalodon" = ret[9], "Tombo&Nanopolish" = ret[10],
             "Tombo&DeepMod" = ret[11], "Tombo&Megalodon" = ret[12], "Nanopolish&DeepMod" = ret[13], "Nanopolish&Megalodon" = ret[14], "DeepMod&Megalodon" = ret[15],
             "DeepSignal&Tombo&Nanopolish" = ret[16], "DeepSignal&Tombo&DeepMod" = ret[17], "DeepSignal&Tombo&Megalodon" = ret[18], "DeepSignal&Nanopolish&DeepMod" = ret[19],
             "DeepSignal&Nanopolish&Megalodon" = ret[20], "DeepSignal&DeepMod&Megalodon" = ret[21], "Tombo&Nanopolish&DeepMod" = ret[22],
             "Tombo&Nanopolish&Megalodon" = ret[23], "Tombo&DeepMod&Megalodon" = ret[24], "Nanopolish&DeepMod&Megalodon" = ret[25],
             "DeepSignal&Tombo&Nanopolish&DeepMod" = ret[26], "DeepSignal&Tombo&Nanopolish&Megalodon" = ret[27], "DeepSignal&Tombo&DeepMod&Megalodon" = ret[28], "DeepSignal&Nanopolish&DeepMod&Megalodon" = ret[29], "Tombo&Nanopolish&DeepMod&Megalodon" = ret[30],
             "DeepSignal&Tombo&Nanopolish&DeepMod&Megalodon" = ret[31]
    )
    
    # print(comb)
    fit1 <- euler(comb, input = 'union', shape = 'circle')
    # print(fit1$original.values)
    return(fit1)
