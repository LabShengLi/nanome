"""
=================================================================
TCGA global variable initializations
=================================================================
...
if sys.platform == 'linux':  # Linux helix dir config
    ...
    project_base_dir = "/projects/li-lab/nmf_epihet/tcgajax"
...
# create 4 folders if needed
ensure_dir(dataset_base_dir)
ensure_dir(pic_base_dir)
ensure_dir(pkl_base_dir)
...
def init_logging():
    ...
    console_handler.setLevel(log_level_prj)
    ...
    file_handler.setLevel(log_level_prj)
